...
if __name__ == "__main__":
    ...
    semilla_original, k, archivos_Dat, num_sol, num_sol_greedy, num_ejecuciones, iteraciones, n_elite, k_best, k_worst, prob_mutacion, tiempo_max, operador_cruce, probabilidad_cruce = extraccion_Datos.cargar_datos(
        configuracion)
